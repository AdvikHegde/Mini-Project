...
class class1 implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == b4) {
            ...
            JLabel l1 = new JLabel("Username :");
            l1.setBounds(450, 200, 200, 20);
            l1.setFont(Font1);
            f.add(l1);

            JTextField t1 = new JTextField(20);
            t1.setBounds(550, 200, 200, 20);
            f.add(t1);
            // try to insert background image in label
            ImageIcon image;
            try {
                image = new ImageIcon(getClass().getResource("C:\\Users\\Ashika\\Desktop"));
            ...
            // LABEL 2
            JLabel l2 = new JLabel("Password :");
            l2.setBounds(450, 300, 200, 20);
            l2.setFont(Font1);
            f.add(l2);

            JTextField t2 = new JTextField(20);
            t2.setBounds(550, 300, 200, 20);
            f.add(t2);
